package com.Orio.wither_project.service.data.gathering.collecting.impl;
...
@Service
@Primary
public class ParallelSourceCollectorService implements ISourceCollectorService {

    private static final Logger logger = getLogger(ParallelSourceCollectorService.class);
