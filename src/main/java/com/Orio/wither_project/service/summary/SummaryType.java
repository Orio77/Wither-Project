...
public enum SummaryType implements ISummaryType {
    ...
    CHAPTER {
        @Override
        public String getSystemPrompt() {
            return "You are a helpful assistant. Create a comprehensive chapter summary from these page summaries.";
        }
    ...
    BOOK {
        @Override
        public String getSystemPrompt() {
            return "You are a helpful assistant. Create an overall book summary from these chapter summaries.";
        }
