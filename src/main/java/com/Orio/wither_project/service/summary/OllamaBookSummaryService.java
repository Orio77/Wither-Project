...
// LoggerFactory.getLogger(OllamaBookSummaryService.class);
...
// // Add debug logging for the actual summary content
// if (summary instanceof AbstractSummaryModel) {
// String summaryContent = ((AbstractSummaryModel) summary).getContent();
// logger.debug("Generated {} summary content: {}",
// type.getClass().getSimpleName(),
// summaryContent != null ? summaryContent : "null");
// }
// return summary;
// } catch (Exception e) {
...
// @Override
// public <T, E extends ProgressivelySummarizable<T>> E
...
// AbstractSummaryModel summary = createSummary(combinedText, type);
// container.setContent(summary.getContent());
...
// return pages.stream()
// .<PageSummaryModel>map(page -> createSummary(page.getContent(),
// SummaryType.PAGE))
// .toList();
// }
...
// return createProgressiveSummary(pageSummaries, SummaryType.CHAPTER,
// container);
// }
...
// return createProgressiveSummary(chapterSummaries, SummaryType.BOOK,
// container);
// }
