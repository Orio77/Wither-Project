...
// LoggerFactory.getLogger(PDFEndpointService.class);
// private final ISQLPDFService sqlpdfService;
// private final IAIBookProcessingService bookProcessingService;

// @Transactional
// public boolean uploadPDF(MultipartFile file, String name, List<Integer>
// startChapterPages) {
...
// String givenName = (name == null || name.trim().isBlank()) ?
...
// BookModel pdfDocument = bookProcessingService.processPDFDocument(document,
// givenName, startChapterPages);
