...
public class GatherController {
    ...
    private final IGatherOrchestrationService orchestrationService;

    @PostMapping(value = ApiPaths.GATHER, produces = MediaType.APPLICATION_JSON_VALUE, consumes = MediaType.APPLICATION_JSON_VALUE)
    public ResponseEntity<List<InformationPiece>> gatherData(@RequestBody QueryRequest request) {
        ...
        try {
            List<InformationPiece> res = orchestrationService.gather(query);
