// package com.Orio.wither_project.gather.processing.qa.impl;
...
// LoggerFactory.getLogger(OllamaQAService.class);

// private static final String JSON_FORMAT = "json";
// private static final String SYSTEM_PROMPT = """
// Act as an analyst who examines the text to identify and extract valuable
// fragments that fully explain ideas.
// Ignore any text that doesn't encapsulate the idea fully. Ignore any text that
// doesn't contain a meaningful idea at all.
// Avoid technical metadata or irrelevant content such as URLs, image captions,
// or locations. Only return content that adds value to understanding.
// Be strict and don't hesitate to respond with "null" if no such fragment is
// present.
// Provide a brief analysis of the text in the search for a valuable fragment (3
// sentences).
// If such fragment is found, provide first and last 3 words of the fragment to
// indicate where it can be found. The words must be exactly quoted from the
// text.
// If such fragment found, provide an up-to-5-word question the fragment
// answers. Make the question related to the idea itself, not the text.
// """;
// private static final String JSON_FORMAT_PROMPT = """
// Respond in the following json format: {
// "analysis": "A brief analysis of the text",
// "first_three_words": "First three words that indicate where the valuable
// fragment begins",
// "last_three_words": "Last three words that indicate where the valuable
// fragment ends",
...
// private ChatRequest createChatRequest(DataModel dataPiece, OllamaOptions
// options) {
// if (dataPiece == null || dataPiece.getContent() == null) {
// throw new IllegalArgumentException("DataModel or its content cannot be
// null");
// }
...
// logger.warn("Failed to parse JSON response for data piece: {}",
// dataPiece.getId());
// return;
// }
...
// private void updateDataModel(DataModel dataPiece,
// OllamaThreeWordsResponseModel responseModel) {
...
// logger.warn("Incomplete response model for data piece: {}",
// dataPiece.getId());
// return;
// }
...
// if (fragment == null) {
// logger.warn("Could not extract fragment for data piece: {}",
// dataPiece.getId());
// return;
// }

// logger.debug("Generated question: '{}' for fragment: '{}'", question,
// fragment);
