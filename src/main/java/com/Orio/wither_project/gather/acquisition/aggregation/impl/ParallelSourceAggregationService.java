...
@Service
@Primary
public class ParallelSourceAggregationService implements ISourceAggregationService {

    private static final Logger logger = getLogger(ParallelSourceAggregationService.class);
