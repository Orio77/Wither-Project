package com.Orio.wither_project.summary.summary.service.impl;
...
import com.Orio.wither_project.summary.summary.service.IPDFParallelSummaryGenerationService;
...
public class OllamaParallelSummaryGenerationService implements IPDFParallelSummaryGenerationService {
    ...
    @Override
    public BookSummaryModel generateBookSummary(DocumentModel doc) {
        ...
        BookSummaryModel bookSummary = new BookSummaryModel(bookSummaryText);
